(function (root) {
  ...
  const GENRE_HINTS = {
    ...
    "AI": {
      axis: "仕事",
      scenes: ["生成AIに文章を直してもらった瞬間", "会議資料をAIで要約した昼", "AIの回答を見直した夜", "仕事でAI導入の話が出た場面", "プロンプトを何度も直した時間", "AIっぽい文章に違和感を持った瞬間"],
      angles: ["便利なのに最後は人間が責任を持つ話", "AIに任せるほど自分の判断が問われる", "効率化と手抜きの境目", "人間らしさが逆に目立つ時代"]
    },
    "プロ野球": {
      axis: "仕事",
      scenes: ["9回裏を見ていた夜", "推しチームの連敗ニュース", "先発投手の交代場面", "守備のミスを見た瞬間", "ヒーローインタビュー", "順位表を見た朝"],
      angles: ["数字だけでは語れない勝負", "一球で空気が変わる怖さ", "調子が悪い時の踏ん張り", "仕事にも通じるチームの空気"]
    },
    "政治": {
      axis: "仕事",
      scenes: ["国会ニュースを見た朝", "物価対策の話題", "選挙のニュース", "政策発表を読んだ昼", "税金の話を聞いた瞬間", "街頭インタビューを見た夜"],
      angles: ["生活に近い政治の話", "きれいごとより現場感", "怒りすぎず鋭く見る", "誰か任せにしすぎない姿勢"]
    },
    "経済": {
      axis: "仕事",
      scenes: ["為替ニュースを見た朝", "株価の大きな値動き", "物価上昇の記事", "賃上げニュース", "決算発表を眺めた昼", "日銀や金利の話題"],
      angles: ["ニュースが家計に降りてくる感覚", "数字の裏にある生活感", "景気の良さが自分に届かない違和感", "投資目線と生活目線のズレ"]
    },
    "会社生活": {
      axis: "仕事",
      scenes: ["朝の出社直後", "上司と部下の間に立った場面", "会議が長引いた午後", "チャット通知が止まらない日", "退勤前の急ぎ案件", "昼休みに一息ついた瞬間"],
      angles: ["大企業の板挟みあるある", "静かな疲れを少し笑う", "正論と現場のズレ", "会社員の小さな生存戦略"]
    },
    "競馬": {
      axis: "競馬",
